...
public class EcommerceWebsiteAutomation{
	 ...
	 public static Boolean TestCase01(EdgeDriver driver) throws InterruptedException{
		 Boolean status;
	 ...
	 public static Boolean TestCase02(EdgeDriver driver) throws InterruptedException{
		 Boolean status;
	 ...
	 public static Boolean TestCase03(EdgeDriver driver) throws InterruptedException{
		 Boolean status;
	 ...
	 public static Boolean TestCase04(EdgeDriver driver) throws InterruptedException{
		 Boolean status;
		 logStatus("Start TestCase", "Test Case 04: Checkout functionality", "DONE");
		 CheckoutPage checkout= new CheckoutPage(driver);
		 checkout.navigateToCartPage();
		 status=checkout.PerformCheckoutFunctionality("Hima", "Koushal", "1234");
		 if (!status) {
	 ...
	 public static Boolean TestCase05(EdgeDriver driver) throws InterruptedException{
		 Boolean status;
